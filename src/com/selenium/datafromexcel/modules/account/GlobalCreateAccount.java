...
public class GlobalCreateAccount extends AccountTestSuiteBase {
	
	static Utilities obj = null;
	GlobalCreateAccount obj1 = null;
	...
	public void runBeforeMethod() {
        ...
        actualText =  driver.findElement(By.cssSelector(getORValue("actualText"))).getText();
		...
		accountActualText = driver.findElement(By.cssSelector(getORValue("accountActualText"))).getText();
	}
	...
	@Test(dataProvider="getAccountCreateData")
