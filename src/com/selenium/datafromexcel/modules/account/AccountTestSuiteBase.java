...
public class AccountTestSuiteBase extends Base{
	...
	public void checkSuiteSkip() throws Exception{
		...
		APP_LOGS.debug("Checking Runmode of Create Account");
		if(!TestUtil.isSuiteRunnable(suiteXls, "Create Account")){
			APP_LOGS.debug("Skipped Create Account Suite as the runmode was set to NO");
			throw new SkipException("RUnmode of Create Account Suite set to no. So Skipping all tests in Create Account Suite");
